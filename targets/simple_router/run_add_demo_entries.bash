...
python ../../cli/pd_cli.py -p simple_router -i pd_thrift.simple_router -s $PWD/of-tests:$PWD/../../submodules/oft-infra -m "add_entry send_frame 2 rewrite_mac 00:aa:bb:00:00:01" -c localhost:22222
